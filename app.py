...
def compare(prediction, X_test):
    ...
    diff = abs(prediction[11]-int(X_test[0]))+abs(prediction[3]-int(X_test[1]))+abs(prediction[4]-int(X_test[2]))+abs(
        prediction[5]-int(X_test[3]))+abs(prediction[6]-int(X_test[4]))+abs(prediction[7]-int(X_test[5]))+abs(prediction[8]-int(X_test[6]))
    diff_mean = diff/7
    return diff_mean
